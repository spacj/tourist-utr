...
const COUNTRIES = [
  {
    ...
    active: true,
    comingSoon: false,
    imageUrl: 'https://images.unsplash.com/photo-1512470876302-972faa2aa9a4?w=1600&q=85&auto=format&fit=crop',
    i18n: {
...
const CITIES = [
  {
    ...
    coverEmoji: '🇳🇱',
    imageUrl: 'https://images.unsplash.com/photo-1597212618440-f74937c2cb98?w=1200&q=85&auto=format&fit=crop',
    priceEuros: 5,
    order: 0,
    active: true,
    i18n: {
