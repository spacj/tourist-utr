...
relatedHunts: [tour_rome_trastevere]
---
...
![A plate of cacio e pepe](https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Cacio_e_pepe.jpg/1200px-Cacio_e_pepe.jpg)
_Cacio e pepe — pecorino, pepper, and the cooking water do all the work._
...
{
  "kind": "tour",
  "targetId": "tour_rome_trastevere",
  "title": "Get the full self-guided crawl",
  "description": "All 5 stops, GPS-guided, in-app maps, fun facts at every stop. €5 unlocks Rome forever and the first stop is on us."
}
```

## Stop 4 — Wine cellar at Enoteca Ferrara
...
```cta
{
  "kind": "city",
  "targetId": "city_rome",
  "title": "Or pick something else in Rome",
  "description": "Rome on TourHunts is just getting started. The Trastevere tour is live; classic Colosseum + Vatican hunts ship next."
}
```
