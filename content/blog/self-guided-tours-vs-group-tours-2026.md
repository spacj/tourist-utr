...
{
  "kind": "tour",
  "targetId": "tour_milan_aperitivo",
  "title": "Try the Milan Aperitivo Tour",
  "description": "A 5-stop self-guided crawl through the most iconic terraces in Milan — first one's on us if you've never tried a TourHunts tour."
}
```
...
{
  "kind": "multiplayer",
  "title": "Or race friends through a hunt",
  "description": "Real-time multiplayer races. Your friend takes Amsterdam, you take Utrecht — first to all 8 stops wins. Free first hunt in every city."
}
```
